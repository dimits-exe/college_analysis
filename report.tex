...
\begin{document}
	...
	The study is structured as follows: In Section \ref{sec::results} we make general observations about our data, form our first hypotheses and follow up with robust analyses and regression models to prove/disprove these hypotheses. Section \ref{sec::conclusions} follows with an overview and discussion about our findings. Finally, in Section \ref{sec::addendum} we include graphs, tables and supporting documents.
